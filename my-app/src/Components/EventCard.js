...
const EventCard = () => {
  return (
    <div className='event-card bg-green-700 w-[350px] h-[220px] m-4 rounded-2xl shadow-xl shadow-gray-300 relative flex-shrink-0 hover:shadow-2xl hover:shadow-gray-400' >
