          ...
          <div class="grid min-h-full place-items-center bg-white px-6 py-24 sm:py-32 lg:px-8">
            <div class="text-center">
              ...
              <div class="mt-10 flex items-center justify-center gap-x-6">
                ...
                <Link to="https://chat.whatsapp.com/HkHoCm9Rfv6Cxgt4MOtm5K" class="text-sm font-semibold text-gray-900">Contact community <span aria-hidden="true">&rarr;</span></Link>
              </div>
            </div>
          </div>
        </div>
